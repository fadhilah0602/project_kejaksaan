...
import 'package:project_informasi/page/admin/pengawasan_aliran/list_pengawasan.dart';
import 'package:project_informasi/page/admin/penyuluhan_hukum/list_penyuluhan.dart';
import 'package:project_informasi/page/admin/pidana_korupsi/list_korupsi.dart';
import 'package:project_informasi/page/admin/posko_pilkada/list_posko.dart';
            ...
            child: AppBar(
              ...
              title: TextField(
                decoration: InputDecoration(
                    hintText: "Sistem Informasi Kejaksaan",
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ListPengaduanScreen()));
                    },
                    child: Card(
                      child: SizedBox(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ListKorupsiScreen()));
                    },
                    child: Card(
                      child: SizedBox(
                        width: 150, // Atur lebar sesuai kebutuhan Anda
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ListPenyuluhanScreen()));
                    },
                    child: Card(
                      child: SizedBox(
                        width: 150, // Atur lebar sesuai kebutuhan Anda
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ListPengawasanScreen()));
                    },
                    child: Card(
                      child: SizedBox(
                        width: 150, // Atur lebar sesuai kebutuhan Anda
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ListPoskoScreen()));
                    },
                    child: Card(
                      child: SizedBox(
                        width: 150, // Atur lebar sesuai kebutuhan Anda
