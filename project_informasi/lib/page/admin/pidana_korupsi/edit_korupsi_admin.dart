...
class EditKorupsiAdmin extends StatefulWidget {
  ...
  const EditKorupsiAdmin({Key? key, required this.korupsi})
      : super(key: key);
...
class _EditKorupsiAdminState extends State<EditKorupsiAdmin> {
  ...
  void initState() {
    ...
    _namapelaporController =
        TextEditingController(text: widget.korupsi.data[0].nama_pelapor);
    _nohpController =
        TextEditingController(text: widget.korupsi.data[0].no_hp);
    _ktpController = TextEditingController(text: widget.korupsi.data[0].ktp);
    _ktp_pdfController =
        TextEditingController(text: widget.korupsi.data[0].ktp_pdf);
    _uraianController =
        TextEditingController(text: widget.korupsi.data[0].uraian);
    _laporanController =
        TextEditingController(text: widget.korupsi.data[0].laporan);
    _laporan_pdfController =
        TextEditingController(text: widget.korupsi.data[0].laporan_pdf);
    _statusValue = widget.korupsi.data.first.status;
    // _statusValue =
  ...
  Future<void> _downloadPdf(String type) async {
    String pdfUrl;
    if (type == 'laporan') {
      pdfUrl = 'http://192.168.42.183/informasi/${widget.korupsi.data[0].laporan_pdf}';
    } else {
      pdfUrl = 'http://192.168.42.183/informasi/${widget.korupsi.data[0].ktp_pdf}';
    }
  ...
  Future<void> downloadPDF(String fileName) async {
    String url = 'http://192.168.42.183/informasi/korupsi.php?file=$fileName';
    try {
      var dio = Dio();
  ...
  Future<void> saveChanges(String newNamaPelapor, String newNohp, String newKtp, String newKtpPdf, String newUraian,String newLaporan,  String newLaporanPdf, String newStatus) async {
    ...
    Uri uri = Uri.parse('http://192.168.42.183/informasi/updateAdminKorupsi.php');
    http.MultipartRequest request = http.MultipartRequest('POST', uri)
      ...
      ..fields['uraian'] = newUraian  // Menggunakan nilai baru
        ...
        child: Column(
          ...
          children: [
            Card(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Nama Pelapor  : ' + (widget.korupsi.data[0].nama_pelapor ?? 'Loading...'),
                      style: TextStyle(
                        fontFamily: 'Jost',
                        fontSize: 14,
                        color: Colors.black,
                    ...
                    Text(
                      'No HP               : ' + (widget.korupsi.data[0].no_hp ?? 'Loading...'),
                      style: TextStyle(
                        fontFamily: 'Jost',
                        fontSize: 14,
                        color: Colors.black,
                    ...
                    Text(
                      'Uraian                   : ' + (widget.korupsi.data[0].uraian ?? 'Loading...'),
                      style: TextStyle(
                        fontFamily: 'Jost',
                        fontSize: 14,
                        color: Colors.black,
                    ...
                    SizedBox(height: 5), // Jarak antar teks
                    Text(
                      'KTP                   : ' + (widget.korupsi.data[0].ktp ?? 'Loading...'),
                      style: TextStyle(
                        fontFamily: 'Jost',
                        fontSize: 14,
                        color: Colors.black,
                    ...
                    SizedBox(height: 5), // Jarak antar teks
                    Text(
                      'Laporan            : ' + (widget.korupsi.data[0].laporan ?? 'Loading...'),
                      style: TextStyle(
                        fontFamily: 'Jost',
                        fontSize: 14,
                        color: Colors.black,
            ...
            Container(
              ...
              child: InkWell(
                onTap: () {
                  saveChanges(_namapelaporController.text, _nohpController.text, _uraianController.text,
