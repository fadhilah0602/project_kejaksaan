...
class AddKorupsiCustomersScreen extends StatefulWidget {
  const AddKorupsiCustomersScreen({Key? key}) : super(key: key);

  @override
  State<AddKorupsiCustomersScreen> createState() => _AddKorupsiCustomersScreenState();
}

class _AddKorupsiCustomersScreenState extends State<AddKorupsiCustomersScreen> {
  ...
  Future<void> addPengaduan() async {
    ...
    try {
      Uri uri = Uri.parse('http://192.168.42.183/informasi/addKorupsi.php');
