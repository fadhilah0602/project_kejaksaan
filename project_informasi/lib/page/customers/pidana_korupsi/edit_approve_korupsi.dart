...
class EditKorupsiApproveScreen extends StatefulWidget {
  final ModelKorupsi korupsi;

  const EditKorupsiApproveScreen({Key? key, required this.korupsi})
      : super(key: key);

  @override
  State<EditKorupsiApproveScreen> createState() => _EditKorupsiApproveScreenState();
}

class _EditKorupsiApproveScreenState extends State<EditKorupsiApproveScreen> {
  ...
  void initState() {
    ...
    _ktpController =
        TextEditingController(text: widget.korupsi.data[0].ktp);
    _uraianController =
    ...
    _statusController =
        TextEditingController(text: widget.korupsi.data[0].status);
  }
