...
class EditPengawasanApproveScreen extends StatefulWidget {
  final ModelPengawasan pengawasan;

  const EditPengawasanApproveScreen({Key? key, required this.pengawasan})
      : super(key: key);

  @override
  State<EditPengawasanApproveScreen> createState() => _EditPengawasanApproveScreenState();
}

class _EditPengawasanApproveScreenState extends State<EditPengawasanApproveScreen> {
  ...
  void initState() {
    ...
    _ktpController =
        TextEditingController(text: widget.pengawasan.data[0].ktp);
    _ktpPdfController =
    ...
    _statusController =
        TextEditingController(text: widget.pengawasan.data[0].status);
  }
