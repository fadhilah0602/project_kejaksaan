...
class EditPengaduanApproveScreen extends StatefulWidget {
  final ModelPengaduan pengaduan;

  const EditPengaduanApproveScreen({Key? key, required this.pengaduan})
      : super(key: key);

  @override
  State<EditPengaduanApproveScreen> createState() => _EditPengaduanApproveScreenState();
}

class _EditPengaduanApproveScreenState extends State<EditPengaduanApproveScreen> {
  ...
  void initState() {
    ...
    //     TextEditingController(text: widget.pengaduan.data[0].no_hp);
    // _ktpController =
    //     TextEditingController(text: widget.pengaduan.data[0].ktp);
    // _ktpPdfController =
