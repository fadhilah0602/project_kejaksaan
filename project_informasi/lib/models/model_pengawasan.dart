class ModelPengawasan {
  ...
  late final List<Pengawasan> data;

  ModelPengawasan.fromJson(Map<String, dynamic> json) {
    isSuccess = json['isSuccess'];
    message = json['message'];
    data = List.from(json['data']).map((e) => Pengawasan.fromJson(e)).toList();
  }
...
class Pengawasan {
  ...
  late final String id_pengawasan;
  ...
  Pengawasan.fromJson(Map<String, dynamic> json) {
    id_user = json['id_user'].toString();
    id_pengawasan = json['id_pengawasan'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['id_pengawasan'] = id_pengawasan;
