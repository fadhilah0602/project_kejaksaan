...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['id_user'])) {
        ...
        $sql = "SELECT * FROM posko WHERE id_user = ?";
        ...
        if($result->num_rows > 0) {
            ...
            $response['message'] = "Berhasil menampilkan data Posko Pilkada";
            $response['data'] = array();
            ...
            $response['message'] = "Tidak ada data Posko Pilkada untuk pengguna ini";
            $response['data'] = [];
        }
