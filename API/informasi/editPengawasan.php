...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['id_pengawasan']) && isset($_POST['id_user']) && isset($_POST['laporan']) && isset($_POST['ktp']) && isset($_POST['nama_pelapor']) && isset($_POST['no_hp'])) {
        ...
        $sql = "UPDATE pengawasan SET id_user='$id_user', laporan_pdf='$laporan_pdf', ktp_pdf='$ktp_pdf', laporan='$laporan', ktp='$ktp', nama_pelapor='$nama_pelapor', no_hp='$no_hp', status='$status' WHERE id_pengawasan='$id_pengawasan'";
        if ($koneksi->query($sql) === TRUE) {
            $response['isSuccess'] = true;
            $response['message'] = "Berhasil mengedit data pengawasan aliran";
        } else {
            $response['isSuccess'] = false;
            $response['message'] = "Gagal mengedit data pengawasan aliran: " . $koneksi->error;
        }
    } else {
        $response['isSuccess'] = false;
