...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['id_user'])) {
        ...
        $sql = "SELECT * FROM penyuluhan WHERE id_user = ?";
        ...
        if($result->num_rows > 0) {
            ...
            $response['message'] = "Berhasil menampilkan data Penyuluhan Hukum";
            $response['data'] = array();
            ...
            $response['message'] = "Tidak ada data Penyuluhan Hukum untuk pengguna ini";
            $response['data'] = [];
        }
