...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['id_korupsi']) && isset($_POST['id_user']) && isset($_POST['laporan']) && isset($_POST['ktp']) && isset($_POST['nama_pelapor']) && isset($_POST['no_hp']) && isset($_POST['uraian'])) {
        ...
        $sql = "UPDATE korupsi SET id_user='$id_user', laporan_pdf='$laporan_pdf', ktp_pdf='$ktp_pdf', laporan='$laporan', ktp='$ktp', nama_pelapor='$nama_pelapor', no_hp='$no_hp', uraian='$uraian', status='$status' WHERE id_korupsi='$id_korupsi'";
        if ($koneksi->query($sql) === TRUE) {
            $response['isSuccess'] = true;
            $response['message'] = "Berhasil mengedit data pidana korupsi";
        } else {
            $response['isSuccess'] = false;
            $response['message'] = "Gagal mengedit data pidana korupsi: " . $koneksi->error;
        }
    } else {
        $response['isSuccess'] = false;
