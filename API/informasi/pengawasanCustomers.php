...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['id_user'])) {
        ...
        $sql = "SELECT * FROM pengawasan WHERE id_user = ?";
        ...
        if($result->num_rows > 0) {
            ...
            $response['message'] = "Berhasil menampilkan data Pengawasan Aliran";
            $response['data'] = array();
            ...
            $response['message'] = "Tidak ada data Pengawasan Aliran untuk pengguna ini";
            $response['data'] = [];
        }
